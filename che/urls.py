...
from .views import (
    ...
    DepositoNew,
    DepositoEdit,
    imprimir_deposito_list,
    DepositoDetailView,
    search,
    Vista_pagar,
    imprimir_che_pagar,
    reporte_che_entregados,
    ChequeEntregadoView,
    ChequeEntregadoNew,
    cheques_rechazados,
    ChequeRechazadoView,
    ...
    search_factura,
    FacturaDetail,
    search_cheque_numero,
    Abono_EquivocadoView,
    Abonos_equivocados,
    PDFFacturasNegativos,
    PDFHistorial_Cheques,
    Abono_Fac_equi_edit,
    Abono_Fac_edit,
...
urlpatterns = [
    ...
    path(
        "cheque/imprimir-todas/<str:f1>/<str:f2>",
        imprimir_cheque_list,
        name="cheque_print_all",
    ),
    path(
        "cheque/imprimir-imagen/<str:f1>/<str:f2>",
        imprimir_cheque_img.as_view(),
        name="cheque_print_img",
    ),
    path(
        "cheque/pdfproveedor/<str:f5>/<str:f6>/<str:categoria>",
        imprimir_provedor,
        name="proveedor_print_prove",
    ),
    path(
        "cheque/pdfbanco/<str:f5>/<str:f6>/<str:categoria>",
        imprimir_banco,
        name="cheque_print_banco",
    ),
    ...
    path(
        "deposito/imprimir-deposito/<str:f1>/<str:f2>",
        imprimir_deposito_list,
        name="deposito_print_all",
    ),
    path(
        "detalle/deposito/<int:id>",
        DepositoDetailView.as_view(),
        name="detail_deposito",
    ),
    # path('cheque/estado/<int:id>', Cheque_inactivar, name='cheque_inactivar'),
    ...
    path(
        "cheque-rechazado/", ChequeRechazadoView.as_view(), name="cheque_rechazado_list"
    ),
    path(
        "che-rechazado/new", ChequeRechazadoNew.as_view(), name="cheque_rechazado_new"
    ),
    path(
        "cheques-recha-all",
        ChequeGeneratePendintesPDF.as_view(),
        name="cheques_recha_all",
    ),
    ...
    path(
        "factura/buscar-proveedor",
        factura_modal_proveedor,
        name="factura_modal_proveedor",
    ),
    path(
        "factura/fac-proveedor-pdf/<str:f1>/<str:f2>/<str:proveedor>",
        factura_proveedor_pdf,
        name="fac_proveedor_pdf",
    ),
    path("abono/", Abono_FacturaView.as_view(), name="abono_factura_list"),
    path(
        "abono-equivocado/",
        Abono_EquivocadoView.as_view(),
        name="abono_factura_equi_list",
    ),
    path("abono/new-equi/", Abonos_equivocados.as_view(), name="abono_fac_equi_new"),
    path(
        "abono/editar/<int:pk>/", Abono_Fac_equi_edit.as_view(), name="abono_fac_edit"
    ),
    path(
        "abono/editar-abono/<int:pk>/",
        Abono_Fac_edit.as_view(),
        name="abono_fac_edit_equi",
    ),
    ...
    path(
        "<int:pk>/imprimir-detalle/",
        PDFHistorial_Cheques.as_view(),
